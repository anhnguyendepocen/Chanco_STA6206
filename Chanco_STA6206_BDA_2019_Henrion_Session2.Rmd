...
How do you come up with a uninformative prior?
...
Sir Harold Jeffreys devised a general rule for generating an objective or noninformative priors for a sampling model $p(y|\theta)$. The **Jeffreys prior** is given by
