...
find the posterior distribution $p(\pi|k=2)$.
...
* If you don’t want to favor any one value over another, use a non-informative or diffuse prior, e.g. the uniform prior.
